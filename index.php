<!-- 
    /*
    Autor: Juan David Resendiz García
    Fecha de Creación: 27 de noviembre de 2023
    Descripción: Sistema Punto de Venta, proyecto para la materia Proyecto Integrador I A - 004
    */
 -->
...
<body>
    <div class="container index text-center mt-5 mb-5">
        ...
        <a href="views/product/product_list.php"><button type="button" class="btn btn-secondary btn2">Lista de
                Productos</button></a>
        <a href="views/product/product_form.php"><button type="button" class="btn btn-secondary btn2">Administrar
                Productos</button></a>
    </div>
</body>
